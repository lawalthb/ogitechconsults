...
$sql = "UPDATE `order_tb` SET `sales_status` = '1' WHERE `order_tb`.`order_no` = $order_id  ";
...
$sql3 = "DELETE FROM `sales_tb` WHERE `sales_tb`.`order_no` = $order_id";
